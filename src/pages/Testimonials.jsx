...
import { FaCheck, FaS, FaStar } from 'react-icons/fa6'
          ...
          <div className='grid grid-cols-1 lg:grid-cols-[1fr_3fr] gap-20 mb-16 rounded-2xl'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-7'>
              <div className=' flex flex-col gap-1 rounded-lg p-4 bg-white'>
                <div className='flexBetween'>
                  <div className='flexCenter gap-x-2'>
                    <img src={user1} alt="user image" height={44} width={44} className='rounded-full'/>
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis ullam ratione a nemo autem, recusandae laborum reiciendis, tenetur molestiae consectetur eveniet officiis ipsam, odio delectus id suscipit eaque voluptatum. Soluta?</p>
                <div className='flex gap-x-1 mt-5'>
                  <img src={product1} alt="product image0" height={44} width={44} className='rounded aspect-square object-cover' />
                  <img src={product2} alt="product image0" height={44} width={44} className='rounded aspect-square object-cover' />
                </div>
              </div>
              ...
              <div className=' flex flex-col gap-1 rounded-lg p-4 bg-white'>
                <div className='flexBetween'>
                  <div className='flexCenter gap-x-2'>
                    <img src={user2} alt="user image" height={44} width={44} className='rounded-full'/>
                    <h5 className='bold-14'>jane Doe</h5>
                  </div>
                  <div className='bg-secondary text-white rounded-full flexCenter gap-x-2 p-1 px-2 text-xs font-semibold'>
                    <FaCheck />
                    Verified
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis ullam ratione a nemo autem, recusandae laborum reiciendis, tenetur molestiae consectetur eveniet officiis ipsam, odio delectus id suscipit eaque voluptatum. Soluta?</p>
                <div className='flex gap-x-1 mt-5'>
                  <img src={product3} alt="product image0" height={44} width={44} className='rounded aspect-square object-cover' />
                  <img src={product4} alt="product image0" height={44} width={44} className='rounded aspect-square object-cover' />
                </div>
              </div>
