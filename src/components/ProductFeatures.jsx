...
const ProductFeatures = () => {
  return (
    <section className='bg-primary rounded-xl mt-6 p-3'>
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 rounded-xl'>
        <div className='flexCenter gap-x-4 p-2 rounded-3xl'>
          ...
          <div>
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint maxime ducimus temporibus exercitationem saepe sequi?</p>
          </div>
        </div>
        <div className='flexCenter gap-x-4 p-2 rounded-3xl'>
          <div className='text-3xl'>
